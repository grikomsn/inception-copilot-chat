...
Thanks for helping improve Inception for GitHub Copilot Chat.

## Before opening work

- Use [Discussions](https://github.com/grikomsn/inception-copilot-chat/discussions/categories/q-a) for setup and usage questions.
